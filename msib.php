...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="msib.php" class="dropdown-item active">MSIB</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MSIB</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="index.php">Beranda</a></li>
                            <li class="breadcrumb-item"><a class="text-white active" aria-current="page">MSIB</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <h2 class="mb-4">MSIB Flagship</h2>
        <div class="row">
            <!-- Card 1 -->
            <div class="col-md-4 mb-4">
                <div class="card shadow">
                    <img src="img/msib.png" class="card-img-top" alt="Gambar 1">
                    <div class="card-body">
                        <h5 class="card-title">Magang/Praktik Kerja</h5>
                        <p class="card-text" style="height: 50px;overflow-y: hidden;">Dapatkan pengalaman dunia kerja secara langsung sebagai persiapan kariermu.</p>
                        <a href="https://kampusmerdeka.kemdikbud.go.id/program/magang/browse/" class="btn btn-primary">Temukan Program</a>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mb-4">
                <div class="card shadow">
                    <img src="img/msib.png" class="card-img-top" alt="Gambar 2">
                    <div class="card-body">
                        <h5 class="card-title" >Studi/Proyek Independen</h5>
                        <p class="card-text" style="height: 50px;overflow-y: hidden;">Jalankan proyek penelitian dengan studi kasus nyata dari para pelaku industri ternama.</p>
                        <a href="https://kampusmerdeka.kemdikbud.go.id/program/studi-independen/browse/" class="btn btn-primary">Temukan Program</a>
                    </div>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-4 mb-4">
                <div class="card shadow">
                    <img src="img/mandiri.png" class="card-img-top object-cover" alt="Gambar 2" height="145.22">
                    <div class="card-body">
                        <h5 class="card-title">Magang Mandiri</h5>
                        <p class="card-text" style="height: 50px;overflow-y: hidden;">Temukan pengalaman dunia kerja yang dikelola langsung oleh perusahaan tanpa ada batasan kuota dan jadwal yang lebih fleksibel.</p>
                        <a href="https://kampusmerdeka.kemdikbud.go.id/program/magang/browse/" class="btn btn-primary">Temukan Program</a>
                    </div>
                </div>
            </div>
        ...
        <h2 class="mb-4">MSIB Mandiri</h2>
        <!-- Card 3 -->
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow">
                    <img src="img/program/msib-mandiri.png" class="card-img-top" alt="Gambar 3" height="145.22">
                    <div class="card-body">
                        <h5 class="card-title">MSIB Mandiri</h5>
                        <p class="card-text">Dapatkan pengalaman dunia kerja secara mandiri sebagai persiapan kariermu.</p>
                        <a href="msib-mandiri.php" class="btn btn-primary">Temukan Program</a>
                    </div>
                </div>
            </div>
        </div>
