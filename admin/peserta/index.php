...
if ($selected_batch) {
    $sql = "SELECT 
            ...
            peserta.prodi,
            peserta.nama_mitra,
            peserta.posisi AS posisi,
            peserta.batch,
            peserta.jenis_program AS peserta_jenis_program,
            program.id AS program_id,
            program.nama AS program_nama
        FROM 
            peserta
        JOIN 
            program ON peserta.id_program = program.id
        WHERE
...
<head>
    <meta charset="utf-8">
    <title>Peserta Lolos MBKM</title>
        ...
        <div class="container mt-5">
            <div class="table-container">
                ...
                <div class="text-right mb-3">
                    <a href="add-peserta.php" class="btn btn-primary font-weight-bold"><i class="fas fa-plus"></i> Add Peserta</a>
                </div>
                            ...
                            <?php if ($result->num_rows > 0) : ?>
                                ...
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td><?= $row['nama_mhs']; ?></td>
                                        <td><?= $row['prodi']; ?></td>
                                        <td><?= $row['peserta_jenis_program']; ?></td>
                                        <td><?= $row['nama_mitra']; ?></td>
                                        <td><?= $row['posisi']; ?></td>
                                        <td>Batch <?= $row['batch']; ?></td>
                                        <td>
                                            <a href="edit-peserta.php?id=<?= $row['peserta_id']; ?>" class="btn btn-warning font-weight-bold"><i class="fas fa-edit"></i> Edit</a>
                                            <a href="delete-peserta.php?id=<?= $row['peserta_id']; ?>" class="btn btn-danger font-weight-bold"><i class="fas fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
