...
<head>
    <meta charset="utf-8">
    <title>Testimoni Alumni MBKM</title>
        ...
        <div class="container mt-5">
            <div class="table-container">
                ...
                <div class="text-right mb-3">
                    <a href="add-testimoni.php" class="btn btn-primary font-weight-bold"><i class="fas fa-plus"></i> Add Testimoni</a>
                </div>
                            ...
                            <?php if ($result->num_rows > 0) : ?>
                                ...
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td><?= $row['testimoni']; ?></td>
                                        <td>
                                            <a href="delete-testimoni.php?id=<?= $row['id']; ?>" class="btn btn-danger font-weight-bold"><i class="fas fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else : ?>
