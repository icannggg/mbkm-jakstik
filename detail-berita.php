...
<body>
    ...
    <div class="container-fluid py-5 mb-5 page-header">
        <div class="container py-5">
            <h1 class="display-3 text-white">Detail Berita</h1>
    ...
    <!-- Article Start -->
    <?php $id = $_GET['id']; ?>
    <?php $berita = mysqli_query($conn, "SELECT * FROM berita WHERE id = '$id' "); ?>
    <?php while ($row = mysqli_fetch_assoc($berita)) : ?>

    <div class="container article-container">
        <h2 class="article-title"><?= $row["judul"] ?></h2>
        <div class="article-meta">
            <span><i class="fas fa-user"></i> Penulis: <?= $row["penulis"] ?></span>
            <span><i class="fas fa-calendar-alt"></i> Tanggal: <?= $row["tanggal_posting"] ?></span>
        </div>
        <div class="article-content">
            <img src="img/<?= $row["gambar"] ?>" alt="Article Image" width="400px" height="300px">
            <p><?= $row["isi"] ?></p>
            </div>
        <div class="article-footer">
            <a href="berita.php">&larr; Kembali ke Berita</a>
        </div>
    </div>
    <?php endwhile; ?>
    <!-- Article End -->
