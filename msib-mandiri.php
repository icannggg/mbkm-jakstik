...
$mandiri = mysqli_query($conn, "SELECT * FROM msib_mandiri");
?>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">MSIB Mandiri</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="index.php">Beranda</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="msib.php">MSIB</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">MSIB Mandiri</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Lowongan MSIB Mandiri</h1>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="course-item bg-light">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid" src="img/mandiri/<?= $row["gambar"] ?>" alt="">
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="detail-mandiri.php?id=<?= $row["id"] ?>" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 30px 30px 30px;">Read More</a>
                                </div>
                            </div>
                            <div class="text-center p-4 pb-0">
                                <h5 class="mb-4"><?= $row["posisi"] ?></h5>
                                <h5 class="mb-4"><?= $row["nama_mitra"] ?></h5>
                            </div>
                            <div class="d-flex border-top">
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Periode: <?= $row["periode_mulai"] ?> Sampai <?= $row["periode_selesai"] ?></small>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
